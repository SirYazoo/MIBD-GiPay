        ...
        <div class="container-fluid"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-2"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-2" style="background-color: #d7d6d6;font-size: 20px;height: 50px;color: rgb(0,0,0);">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item" role="presentation"></li>
                    <li class="nav-item" role="presentation"></li>
                </ul><a href="profToko.php" style="color: rgb(0,0,0);width: 80px;">Profile</a><a href="" style="color: rgb(0,0,0);width: 160px;">Penarikan Dana</a><a href="" style="color: rgb(0,0,0);width: 230px;">Data Pembayaran Toko</a><a href=""
