...
<body>
    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-12"><img class="regToko" src="assets/img/Orang.png" style="height: 250px;" /></div>
            </div>
        </div>
    </div>
    <div class="row register-form"><div class="col-md-8 offset-md-2" style="margin-top: -75px;">
    <form class="custom-form" style="opacity: 1;" action="regPribadi.php" method="POST">
        <h1>Pengguna Pribadi</h1>
        ...
        <button class="btn btn-light submit-button" type="submit" name="reg_pub">Register</button></form>
</div></div>
