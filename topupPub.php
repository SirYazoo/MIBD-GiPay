...
<body>
    <nav class="navbar navbar-light navbar-expand-md" style="background-color: #ffffff;">
        <div class="container-fluid"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button><img src="assets/img/Gipay.png" style="height: 40px;">
            ...
            </div><input class="form-control-plaintext" type="text" value="Welcome, <?php echo $_SESSION['username']; ?>" readonly="" style="width: 205px;font-size: 18px;"><a href="topupPub.php?logout='1'" class="btn btn-primary" role="button">Sign Out</a></div>
    </nav>
        ...
        <div class="col-md-4" style="margin-top: 150px;">
            <div class="text-center border rounded-0 shadow-sm profile-box" style="width: 300px;height: 370px;background-color: #ffffff;margin: auto;margin-top: auto;margin-bottom: auto;">
                ...
                <form class="form-topUpPub" method="POST" action="topupPub.php">
                    <div style="height: 80px;"><input class="form-control-plaintext" type="text" style="text-align:center;" value="777<?php echo $_SESSION['noHp']; ?>" readonly="" style="padding: 30px;"><input name="jumlah" type="text" placeholder="Masukan jumlah saldo" /></div><button name="topup" class="btn btn-primary" type="submit" style="margin-top: 80px;">Top Up</button></div>
                </form>
            </div>
        <div class="col-md-4"></div>
    </div>
